...
public class HollowClientTest {
    ...
    public void testClientAPIHoldsLongLivedReferences() throws IOException {
        ...
        Assertions.assertEquals(1, dataAccess.readInt(1, 0));
        Assertions.assertEquals("one", dataAccess.readString(1, 1));
        Assertions.assertEquals(3, dataAccess.readInt(3, 0));
        Assertions.assertEquals("three", dataAccess.readString(3, 1));
    }
