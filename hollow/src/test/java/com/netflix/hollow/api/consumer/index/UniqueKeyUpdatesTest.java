...
public class UniqueKeyUpdatesTest {
    ...
    void updates(boolean doubleSnapshot) {
        ...
        Assertions.assertNotNull(uki.findMatch(new Key(1, "1", 2)));
        ...
        Assertions.assertNotNull(uki.findMatch(new Key(1, "1", 2)));
        Assertions.assertNotNull(uki.findMatch(new Key(2, "1", 2)));
        ...
        Assertions.assertNotNull(uki.findMatch(new Key(1, "1", 2)));
        Assertions.assertNotNull(uki.findMatch(new Key(2, "1", 2)));
        Assertions.assertNull(uki.findMatch(new Key(3, "1", 2)));
    }
