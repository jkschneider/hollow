...
public class RecordCountVarianceValidatorTests {
    ...
    public void passTestNoMoreChangeThanExpected() {
        ...
        Assertions.assertEquals(3, consumer.getStateEngine().getTypeState("TypeWithPrimaryKey").getPopulatedOrdinals()
                .cardinality());
    }
    ...
    public void testGetChangePercent() {
        ...
        Assertions.assertTrue((Float.compare(99.99999652463547f, val.getChangePercent(0, 28382664)) == 0));
        Assertions.assertTrue((Float.compare(99.646645f, val.getChangePercent(1, 283)) == 0));
