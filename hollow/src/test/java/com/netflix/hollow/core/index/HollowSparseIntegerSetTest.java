...
public class HollowSparseIntegerSetTest {
    ...
    public void testEmptyAndDelta() throws Exception {
        ...
        Assertions.assertEquals(0, hollowIntSet.cardinality());
        ...
        Assertions.assertEquals(11, hollowIntSet.cardinality());// 11 movies released in 2009 as per predicate
    }
    ...
    public void test() throws Exception {
        ...
        HollowSparseIntegerSet hollowIntSet = new HollowSparseIntegerSet(readStateEngine, "Movie", "id.value", getPredicate());
        Assertions.assertFalse(hollowIntSet.get(1));
        Assertions.assertFalse(hollowIntSet.get(2));
        Assertions.assertFalse(hollowIntSet.get(3));
        Assertions.assertFalse(hollowIntSet.get(4));

        Assertions.assertTrue(hollowIntSet.get(77));
        Assertions.assertTrue(hollowIntSet.get(66));
        Assertions.assertTrue(hollowIntSet.get(55));
        Assertions.assertTrue(hollowIntSet.get(512));
        Assertions.assertTrue(hollowIntSet.get(513));
        Assertions.assertTrue(hollowIntSet.get(Integer.MAX_VALUE));
        Assertions.assertTrue(hollowIntSet.get(40));
        Assertions.assertTrue(hollowIntSet.get(28));
        Assertions.assertTrue(hollowIntSet.get(30));
        ...
        Assertions.assertFalse(hollowIntSet.get(512));
    }
