...
public class MultiLinkedElementArrayTest {
    ...
    public void testIterators() {
        ...
        Assertions.assertEquals(0, arr.newList());
        
        arr.add(0, 100);
        arr.add(0, 200);
        arr.add(0, 300);
        
        Assertions.assertEquals(1, arr.newList());
        
        arr.add(1, 101);
        
        Assertions.assertEquals(2, arr.newList());
        
        arr.add(2, 102);
        
        Assertions.assertEquals(3, arr.newList());
        ...
        Assertions.assertEquals(4, arr.newList());
        
        arr.add(4, 0);
        
        Assertions.assertEquals(5, arr.newList());
        
        arr.add(5, 0);
        arr.add(5, 0);
        
        Assertions.assertEquals(6, arr.newList());
    ...
    private void assertIteratorContents(HollowOrdinalIterator iter, int... expectedOrdinals) {
        for(int i=0;i<expectedOrdinals.length;i++) {
            Assertions.assertEquals(expectedOrdinals[i], iter.next());
        }
        
        Assertions.assertEquals(HollowOrdinalIterator.NO_MORE_ORDINALS, iter.next());
    }
