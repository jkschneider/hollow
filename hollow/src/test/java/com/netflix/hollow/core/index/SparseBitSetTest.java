...
public class SparseBitSetTest {
    ...
    public void testRandom() {
        ...
        Assertions.assertEquals(100000, sparseBitSet.cardinality());
        Assertions.assertTrue(sparseBitSet.estimateBitsUsed() > 0);

        for (int i = 0; i < maxValue; i++) {
            if (intIndexed.contains(i))
                Assertions.assertTrue(sparseBitSet.get(i), "Expected in set, but not found the int " + i);
            else Assertions.assertFalse(sparseBitSet.get(i), "Not expected in set, but found the int " + i);
        }
    }
    ...
    public void testEvenNumbersMultipleThread() {
        for (int j = 0; j < 10; j++) {
            ...
            Assertions.assertTrue(sparseBitSet.cardinality() == 250001);
        }
    ...
    public void testInsertLongInBuckets() {
        ...
        Assertions.assertTrue(sparseBitSet.get(8000));
        Assertions.assertTrue(sparseBitSet.get(8001));
        Assertions.assertTrue(sparseBitSet.get(8002));
        Assertions.assertTrue(sparseBitSet.get(8167));
        Assertions.assertTrue(sparseBitSet.get(8067));

        Assertions.assertTrue(sparseBitSet.get(0));
        Assertions.assertTrue(sparseBitSet.get(4095));
        Assertions.assertTrue(sparseBitSet.get(512));

        Assertions.assertFalse(sparseBitSet.get(8003));
        Assertions.assertFalse(sparseBitSet.get(8063));
        Assertions.assertFalse(sparseBitSet.get(7999));
        Assertions.assertFalse(sparseBitSet.get(8168));
        Assertions.assertFalse(sparseBitSet.get(8191));
    }
    ...
    public void testRemoveLongInBuckets() {
        ...
        Assertions.assertFalse(sparseBitSet.get(8000));
        Assertions.assertTrue(sparseBitSet.get(8001));
        Assertions.assertTrue(sparseBitSet.get(8002));
        Assertions.assertTrue(sparseBitSet.get(8067));
        Assertions.assertTrue(sparseBitSet.get(8167));
        ...
        Assertions.assertFalse(sparseBitSet.get(8001));
        Assertions.assertFalse(sparseBitSet.get(8002));
        Assertions.assertTrue(sparseBitSet.get(8067));
        Assertions.assertTrue(sparseBitSet.get(8167));
        ...
        Assertions.assertTrue(sparseBitSet.get(8002));
        Assertions.assertTrue(sparseBitSet.get(8167));
        Assertions.assertFalse(sparseBitSet.get(8067));
        ...
        Assertions.assertTrue(sparseBitSet.get(8002));
        Assertions.assertTrue(sparseBitSet.get(8067));
        Assertions.assertFalse(sparseBitSet.get(8167));
    ...
    public void testFindMaxValue() {
        ...
        sparseBitSet.set(8001);
        sparseBitSet.set(8002);
        Assertions.assertEquals(8002, sparseBitSet.findMaxValue());
        sparseBitSet.set(8067);
        Assertions.assertEquals(8067, sparseBitSet.findMaxValue());
        sparseBitSet.set(8167);
        Assertions.assertEquals(8167, sparseBitSet.findMaxValue());
        sparseBitSet.clear(8167);
        Assertions.assertEquals(8067, sparseBitSet.findMaxValue());
    }
    ...
    public void testCompaction() {
        ...
        Assertions.assertTrue(compactSparseBitSet.get(0));
        Assertions.assertTrue(compactSparseBitSet.get(4095));
        Assertions.assertTrue(compactSparseBitSet.get(512));
        ...
        if (addedValueGreaterThanMax)
            Assertions.fail("Should not be ale to set a value greater than max value in compacted bit set.");
    ...
    public void testResize() {
        ...
        Assertions.assertTrue(resizedSparsedBitSet.get(0));
        Assertions.assertTrue(resizedSparsedBitSet.get(0));
        Assertions.assertTrue(resizedSparsedBitSet.get(4095));
        Assertions.assertTrue(resizedSparsedBitSet.get(512));
    }
}
