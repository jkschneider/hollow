...
public class HollowReadFilterTest extends AbstractStateEngineTest {
    ...
    public void testIgnoredObject() throws IOException {
        ...
        Assertions.assertNull(readStateEngine.getTypeState(objSchema.getName()));
    }
    ...
    public void testIgnoredList() throws IOException {
        ...
        Assertions.assertNull(readStateEngine.getTypeState(listSchema.getName()));
    }
    ...
    public void testIgnoredSet() throws IOException {
        ...
        Assertions.assertNull(readStateEngine.getTypeState(setSchema.getName()));
    }
    ...
    public void testIgnoredMap() throws IOException {
        ...
        Assertions.assertNull(readStateEngine.getTypeState(mapSchema.getName()));
    }
    ...
    public void testExcludedObjectFields() throws Exception {
        ...
        Assertions.assertEquals("field1", filteredSchema.getFieldName(0));
        Assertions.assertEquals("field4", filteredSchema.getFieldName(1));

        Assertions.assertEquals("obj1", typeState.readString(0, 0));
        Assertions.assertEquals("OBJECT number two", typeState.readString(1, 0));
        Assertions.assertEquals("#3", typeState.readString(2, 0));
        Assertions.assertEquals("number four!", typeState.readString(3, 0));

        Assertions.assertEquals(1.01D, typeState.readDouble(0, 1), 0);
        Assertions.assertEquals(2.02D, typeState.readDouble(1, 1), 0);
        Assertions.assertEquals(3.03D, typeState.readDouble(2, 1), 0);
        Assertions.assertEquals(4.04D, typeState.readDouble(3, 1), 0);
    }
    ...
    public void testIncludedObjectFields() throws Exception {
        ...
        HollowObjectSchema filteredSchema = typeState.getSchema();
        Assertions.assertEquals("field2", filteredSchema.getFieldName(0));
        Assertions.assertEquals("field3", filteredSchema.getFieldName(1));
        Assertions.assertEquals("field5", filteredSchema.getFieldName(2));

        Assertions.assertEquals(1000, typeState.readInt(0, 0));
        Assertions.assertEquals(2000, typeState.readInt(1, 0));
        Assertions.assertEquals(3000, typeState.readInt(2, 0));
        Assertions.assertEquals(4000, typeState.readInt(3, 0));

        Assertions.assertEquals("ONE", typeState.readString(0, 1));
        Assertions.assertEquals("TWO", typeState.readString(1, 1));
        Assertions.assertEquals("THREE", typeState.readString(2, 1));
        Assertions.assertEquals("FOUR", typeState.readString(3, 1));

        Assertions.assertEquals(1.1F, typeState.readFloat(0, 2), 0);
        Assertions.assertEquals(2.2F, typeState.readFloat(1, 2), 0);
        Assertions.assertEquals(3.3F, typeState.readFloat(2, 2), 0);
        Assertions.assertEquals(4.4F, typeState.readFloat(3, 2), 0);
    }
