...
public class HollowMapDeltaTest extends AbstractStateEngineTest {
    ...
    public void test() throws IOException {
        ...
        Assertions.assertEquals(4, typeState.maxOrdinal());
    ...
    public void testSingleEmptyMap() throws IOException {
        ...
        Assertions.assertEquals(0, typeState.maxOrdinal());
        Assertions.assertEquals(0, typeState.size(0));
    }
    ...
    public void testSingleMapWith0KeyValueOrdinals() throws IOException {
        ...
        Assertions.assertEquals(0, typeState.maxOrdinal());
        Assertions.assertEquals(1, typeState.size(0));

        HollowMapEntryOrdinalIterator ordinalIterator = typeState.ordinalIterator(0);

        Assertions.assertTrue(ordinalIterator.next());
        Assertions.assertEquals(0, ordinalIterator.getKey());
        Assertions.assertEquals(0, ordinalIterator.getValue());
        Assertions.assertFalse(ordinalIterator.next());
    }
