...
public class HollowSetTest extends AbstractStateEngineTest {
    ...
    public void testContains() throws IOException {
        ...
        if(!foundValue)
            Assertions.fail("Did not find value in PotentialMatchOrdinalIterator");
    }
    ...
    public void testSingleElementWith0Ordinal() throws IOException {
        ...
        Assertions.assertEquals(NO_MORE_ORDINALS, iter.next());
    }
    ...
    public void testStaleReferenceException() throws IOException {
        ...
        try {
            Assertions.assertEquals(0, typeState.size(100));
