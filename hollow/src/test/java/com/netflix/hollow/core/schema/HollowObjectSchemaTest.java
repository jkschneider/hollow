...
public class HollowObjectSchemaTest {
    ...
    public void findsCommonSchemas() {
        ...
        Assertions.assertEquals(1, commonSchema.numFields());
        Assertions.assertEquals("F2", commonSchema.getFieldName(0));
        Assertions.assertEquals(FieldType.LONG, commonSchema.getFieldType(0));

        Assertions.assertEquals(s1.getPrimaryKey(), s2.getPrimaryKey());
        Assertions.assertEquals(s1.getPrimaryKey(), commonSchema.getPrimaryKey());

        {
            ...
            Assertions.assertNotEquals(s1.getPrimaryKey(), s3.getPrimaryKey());
            Assertions.assertNotEquals(s1.getPrimaryKey(), c3.getPrimaryKey());
            Assertions.assertNull(c3.getPrimaryKey());
        }
    }
    ...
    public void findCommonSchema_incompatible() {
        try {
            ...
            Assertions.fail("Expected IncompatibleSchemaException");
        } catch (IncompatibleSchemaException e) {
            Assertions.assertEquals("Test", e.getTypeName());
            Assertions.assertEquals("F1", e.getFieldName());
        }
    }
    ...
    public void findsUnionSchemas() {
        ...
        Assertions.assertEquals(3, unionSchema.numFields());
        Assertions.assertEquals("F1", unionSchema.getFieldName(0));
        Assertions.assertEquals(FieldType.INT, unionSchema.getFieldType(0));
        Assertions.assertEquals("F2", unionSchema.getFieldName(1));
        Assertions.assertEquals(FieldType.LONG, unionSchema.getFieldType(1));
        Assertions.assertEquals("F3", unionSchema.getFieldName(2));
        Assertions.assertEquals(FieldType.STRING, unionSchema.getFieldType(2));

        Assertions.assertEquals(s1.getPrimaryKey(), s2.getPrimaryKey());
        Assertions.assertEquals(s1.getPrimaryKey(), unionSchema.getPrimaryKey());

        {
            ...
            Assertions.assertNotEquals(s1.getPrimaryKey(), u3.getPrimaryKey());
            Assertions.assertNotEquals(s1.getPrimaryKey(), u3.getPrimaryKey());
            Assertions.assertNull(u3.getPrimaryKey());
        }
    }
    ...
    public void filterSchema() {
        ...
        s1.addField("F1", FieldType.INT);
        s1.addField("F2", FieldType.LONG);
        Assertions.assertEquals(2, s1.numFields());

        HollowFilterConfig filter = new HollowFilterConfig();
        filter.addField("Test", "F2");
        HollowObjectSchema s2 = s1.filterSchema(filter);
        Assertions.assertEquals(1, s2.numFields());
        Assertions.assertEquals("F2", s2.getFieldName(0));
    ...
    public void testEqualsWithPrimaryKey() {
...

        {
            ...
            Assertions.assertNotEquals(s1, s2);
            Assertions.assertNotEquals(s1.getPrimaryKey(), s2.getPrimaryKey());
        }
