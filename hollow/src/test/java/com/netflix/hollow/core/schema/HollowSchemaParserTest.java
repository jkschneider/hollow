...
public class HollowSchemaParserTest {
    ...
    public void parsesObjectSchema() throws IOException {
        ...
        Assertions.assertEquals("TypeA", schema.getName());
        Assertions.assertEquals(3, schema.numFields());
        Assertions.assertEquals(FieldType.INT, schema.getFieldType(0));
        Assertions.assertEquals("a1", schema.getFieldName(0));
        Assertions.assertEquals(FieldType.STRING, schema.getFieldType(1));
        Assertions.assertEquals("a2", schema.getFieldName(1));
        Assertions.assertEquals(FieldType.REFERENCE, schema.getFieldType(2));
        Assertions.assertEquals("String", schema.getReferencedType(2));
        Assertions.assertEquals("a3", schema.getFieldName(2));

        // HollowObjectSchame.toString is parsed properly
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void parsesObjectSchemaWithKey() throws IOException {
        ...
        Assertions.assertEquals(new PrimaryKey("TypeA", "a1"), schema.getPrimaryKey());
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void parsesObjectSchemaMultipleWithKey() throws IOException {
        ...
        // Make sure primary key and HollowObjectSchame.toString is parsed properly
        Assertions.assertEquals(new PrimaryKey("TypeA", "a1", "a3.value"), schema.getPrimaryKey());
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void parsesListSchema() throws IOException {
        ...
        Assertions.assertEquals("ListOfTypeA", schema.getName());
        Assertions.assertEquals("TypeA", schema.getElementType());
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void parsesSetSchema() throws IOException {
        ...
        Assertions.assertEquals("SetOfTypeA", schema.getName());
        Assertions.assertEquals("TypeA", schema.getElementType());
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void parsesSetSchemaWithKey() throws IOException {
        ...
        Assertions.assertEquals("SetOfTypeA", schema.getName());
        Assertions.assertEquals("TypeA", schema.getElementType());
        Assertions.assertEquals(new PrimaryKey("TypeA", "id.value"), schema.getHashKey());
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void parsesSetSchemaWithMultiFieldKey() throws IOException {
        ...
        Assertions.assertEquals("SetOfTypeA", schema.getName());
        Assertions.assertEquals("TypeA", schema.getElementType());
        Assertions.assertEquals(new PrimaryKey("TypeA", "id.value", "region.country.id", "key"), schema.getHashKey());
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void parsesMapSchema() throws IOException {
        ...
        Assertions.assertEquals("MapOfStringToTypeA", schema.getName());
        Assertions.assertEquals("String", schema.getKeyType());
        Assertions.assertEquals("TypeA", schema.getValueType());
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void parsesMapSchemaWithPrimaryKey() throws IOException {
        ...
        Assertions.assertEquals("String", schema.getKeyType());
        Assertions.assertEquals("TypeA", schema.getValueType());
        Assertions.assertEquals(new PrimaryKey("String", "value"), schema.getHashKey());
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void parsesMapSchemaWithMultiFieldPrimaryKey() throws IOException {
        ...
        Assertions.assertEquals("String", schema.getKeyType());
        Assertions.assertEquals("TypeA", schema.getValueType());
        Assertions.assertEquals(new PrimaryKey("String", "id.value", "region.country.id", "key"), schema.getHashKey());
        Assertions.assertEquals(schema, HollowSchemaParser.parseSchema(schema.toString()));
    }
    ...
    public void testParseCollectionOfSchemas_reader() throws Exception {
        ...
        try {
            ...
            Assertions.assertEquals(2, schemas.size(), "Should have two schemas");
            Assertions.assertEquals("Minion", schemas.get(0).getName(), "Should have Minion schema");
            Assertions.assertEquals("String", schemas.get(1).getName(), "Should have String schema");
        } finally {
            if (input != null) {
                input.close();
            }
