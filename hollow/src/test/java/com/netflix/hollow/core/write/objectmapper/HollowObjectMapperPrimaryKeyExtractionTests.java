...
public class HollowObjectMapperPrimaryKeyExtractionTests {
    ...
    public void extractsPrimaryKey() {
        ...
        Assertions.assertArrayEquals(new Object[] { 1, "one" }, key1);
        Assertions.assertArrayEquals(new Object[] { 2, "two" }, key2);
        Assertions.assertArrayEquals(new Object[] { 3, "three" }, key3);
    }
    ...
    public void willReturnNullFields() {
        ...
        Assertions.assertArrayEquals(new Object[] { 1, null }, key1);
        Assertions.assertArrayEquals(new Object[] { null, null }, key2);
        Assertions.assertArrayEquals(new Object[] { 2, null }, key3);
        Assertions.assertArrayEquals(new Object[] { null, null }, key4);
    }
    ...
    public void failsIfPrimaryKeyIncludesReferenceField() {
        ...
        try {
            ...
            Assertions.assertEquals("Cannot extract POJO primary key from a REFERENCE mapped field type", expected.getMessage());
        }
    }
