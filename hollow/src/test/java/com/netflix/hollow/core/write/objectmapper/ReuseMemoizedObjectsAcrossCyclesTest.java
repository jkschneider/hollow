...
public class ReuseMemoizedObjectsAcrossCyclesTest {
    ...
    public void reuseObjectsAcrossCycles() throws IOException {
        ...
        Assertions.assertEquals(0, mapper.add(a1));
        Assertions.assertEquals(1, mapper.add(a2));
        Assertions.assertEquals(0, mapper.add(a1));
        ...
        Assertions.assertEquals(0, mapper.add(a1));
        Assertions.assertEquals(2, mapper.add(new TypeA(3)));
        Assertions.assertEquals(1, mapper.add(a2));
        Assertions.assertEquals(1, mapper.add(a2));
    ...
    public void reuseMemoizedListsAcrossCycles() throws IOException {
        ...
        Assertions.assertEquals(0, mapper.add(new ListType(a1)));
        Assertions.assertEquals(1, mapper.add(new ListType(a2)));
        Assertions.assertEquals(0, mapper.add(new ListType(a1)));
        ...
        Assertions.assertEquals(0, mapper.add(new ListType(a1)));
        Assertions.assertEquals(2, mapper.add(new ListType(a3)));
        Assertions.assertEquals(1, mapper.add(new ListType(a2)));

        StateEngineRoundTripper.roundTripDelta(writeEngine, readEngine);

        Assertions.assertEquals(3, readEngine.getTypeState("ListOfTypeA").getPopulatedOrdinals().cardinality());
    }
    ...
    public void reuseMemoizedSetsAcrossCycles() throws IOException {
        ...
        Assertions.assertEquals(0, mapper.add(new SetType(a1)));
        Assertions.assertEquals(1, mapper.add(new SetType(a2)));
        Assertions.assertEquals(0, mapper.add(new SetType(a1)));
        ...
        Assertions.assertEquals(0, mapper.add(new SetType(a1)));
        Assertions.assertEquals(2, mapper.add(new SetType(a3)));
        Assertions.assertEquals(1, mapper.add(new SetType(a2)));

        StateEngineRoundTripper.roundTripDelta(writeEngine, readEngine);

        Assertions.assertEquals(3, readEngine.getTypeState("SetOfTypeA").getPopulatedOrdinals().cardinality());
    }
    ...
    public void reuseMemoizedMapsAcrossCycles() throws IOException {
        ...
        Assertions.assertEquals(0, mapper.add(new MapType(a1)));
        Assertions.assertEquals(1, mapper.add(new MapType(a2)));
        Assertions.assertEquals(0, mapper.add(new MapType(a1)));
        ...
        Assertions.assertEquals(0, mapper.add(new MapType(a1)));
        Assertions.assertEquals(2, mapper.add(new MapType(a3)));
        Assertions.assertEquals(1, mapper.add(new MapType(a2)));

        StateEngineRoundTripper.roundTripDelta(writeEngine, readEngine);

        Assertions.assertEquals(3, readEngine.getTypeState("MapOfIntegerToTypeA").getPopulatedOrdinals().cardinality());
