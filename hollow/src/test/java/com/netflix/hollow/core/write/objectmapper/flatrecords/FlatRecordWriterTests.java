...
public class FlatRecordWriterTests {
    ...
    public void flatRecordsDedupRedundantDataWithinRecords() {
        ...
        Assertions.assertTrue(recSize2 - recSize1 == 1);
    }
    ...
    public void flatRecordsCanBeDumpedToStateEngineWithIdenticalSchemas() throws IOException {
        ...
        Assertions.assertEquals(1, typeA0.getInt("a1"));
        Assertions.assertEquals("two", typeA0.getString("a2"));
        Assertions.assertEquals("three", typeA0.getObject("a3").getString("b1"));
        Assertions.assertEquals(2, typeA0.getSet("a4").size());
        Assertions.assertTrue(typeA0.getSet("a4").findElement("four") != null);
        Assertions.assertTrue(typeA0.getSet("a4").findElement("five") != null);

        Assertions.assertEquals(2, typeA1.getInt("a1"));
        Assertions.assertEquals("two", typeA1.getString("a2"));
        Assertions.assertEquals("four", typeA1.getObject("a3").getString("b1"));
        Assertions.assertEquals(4, typeA1.getSet("a4").size());
        Assertions.assertTrue(typeA1.getSet("a4").findElement("six") != null);
        Assertions.assertTrue(typeA1.getSet("a4").findElement("eight") != null);
        Assertions.assertTrue(typeA1.getSet("a4").findElement("é with acute accent") != null);
        Assertions.assertTrue(typeA1.getSet("a4").findElement("ten") != null);

        GenericHollowObject typeC0 = new GenericHollowObject(consumer.getStateEngine(), "TypeC", 0);

        Assertions.assertEquals("one", typeC0.getString("c1"));
        Assertions.assertEquals("four", typeC0.getObject("c2").getString("b1"));
        
        Assertions.assertEquals(typeC0.getObject("c2").getOrdinal(), typeA0.getSet("a4").findElement("four").getOrdinal());
    }
    ...
    public void flatRecordsCanBeDumpedToStateEnginesWithDifferentButCompatibleSchemas() {
        ...
        Assertions.assertEquals("two", typeA0.getString("a2"));
        Assertions.assertEquals("three", typeA0.getObject("a3").getString("b1"));
        Assertions.assertNull(typeA0.getSet("a4"));
        Assertions.assertNull(typeA0.getBytes("a5"));

        Assertions.assertEquals(2, typeA1.getInt("a1"));
        Assertions.assertEquals("two", typeA1.getString("a2"));
        Assertions.assertEquals("four", typeA1.getObject("a3").getString("b1"));
        Assertions.assertNull(typeA1.getSet("a4"));
        Assertions.assertNull(typeA1.getBytes("a4"));

        GenericHollowObject typeC0 = new GenericHollowObject(consumer.getStateEngine(), "TypeC", 0);

        Assertions.assertTrue(typeC0.isNull("c1"));
        Assertions.assertEquals("three", typeC0.getObject("c2").getString("b1"));
        Assertions.assertTrue(typeC0.isNull("c3"));
        
        Assertions.assertEquals(typeC0.getObject("c2").getOrdinal(), typeA0.getObject("a3").getOrdinal());
    }
