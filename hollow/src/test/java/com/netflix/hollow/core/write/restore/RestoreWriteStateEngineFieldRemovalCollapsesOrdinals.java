...
public class RestoreWriteStateEngineFieldRemovalCollapsesOrdinals extends AbstractStateEngineTest {
    ...
    public void test() throws IOException {
        ...
        Assertions.assertFalse((readStateEngine.getTypeState("TypeA").getListener(PopulatedOrdinalListener.class)).getPopulatedOrdinals().get(2));
        Assertions.assertFalse((readStateEngine.getTypeState("TypeB").getListener(PopulatedOrdinalListener.class)).getPopulatedOrdinals().get(2));
    ...
    private void assertTypeA(int ordinal, int a1, int bOrdinal) {
        ...
        Assertions.assertEquals(bOrdinal, obj.getOrdinal("a2"));
    }
    ...
    private void assertTypeB(int ordinal, int b1) {
        ...
        Assertions.assertEquals(b1, obj.getInt("b1"));
    }
