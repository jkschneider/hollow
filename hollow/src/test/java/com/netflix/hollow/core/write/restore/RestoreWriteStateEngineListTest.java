...
public class RestoreWriteStateEngineListTest extends AbstractStateEngineTest {
    ...
    public void test() throws IOException {
        ...
        Assertions.assertEquals(4, readStateEngine.getTypeState("TestList").maxOrdinal());
        assertList(0, 1, 2, 3);
        assertList(1, 4, 5, 6);
        ...
        Assertions.assertEquals(3, readStateEngine.getTypeState("TestList").maxOrdinal());
    }
    ...
    public void restoreFailsIfShardConfigurationChanges() throws IOException {
        ...
        try {
            ...
            Assertions.fail("Should have thrown IllegalStateException because shard configuration has changed");
    ...
    private void assertList(int ordinal, int... elements) {
        ...
        for(int i=0;i<elements.length;i++) {
            Assertions.assertEquals(elements[i], iter.next());
        }
