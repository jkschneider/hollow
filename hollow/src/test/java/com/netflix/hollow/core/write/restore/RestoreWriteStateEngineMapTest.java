...
public class RestoreWriteStateEngineMapTest extends AbstractStateEngineTest {
    ...
    public void test() throws IOException {
        ...
        Assertions.assertEquals(4, maxOrdinal());
        ...
        Assertions.assertEquals(1, maxOrdinal());
    ...
    private void assertMap(int ordinal, int... elements) {
        ...
        for(int i=0;i<elements.length;i+=2) {
            Assertions.assertEquals(elements[i+1], readState.get(ordinal, elements[i], elements[i] + 100));
        }
    }
