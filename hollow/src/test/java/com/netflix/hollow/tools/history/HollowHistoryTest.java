...
public class HollowHistoryTest extends AbstractStateEngineTest {
    ...
    public void testRemoveType() throws IOException {
        ...
        {
            initWriteStateEngine();
            Assertions.assertNull(writeStateEngine.getTypeState(B_TYPE));
    ...
    public void testHistoricalStates() throws IOException {
        ...
        Assertions.assertEquals(0, history.getNumberOfHistoricalStates());

        {
            ...
            Assertions.assertEquals(1, history.getNumberOfHistoricalStates());
        }
        ...
        HollowHistoricalState[] historicalStates;
        {
            ...
            Assertions.assertEquals(2, history.getNumberOfHistoricalStates());
...

        {
            ...
            Assertions.assertEquals(2, history.getNumberOfHistoricalStates());
            Assertions.assertEquals(historicalStates[0], history.getHistoricalStates()[1]);
        }
    ...
    private void assertRecord(HollowObject obj, int a1, int a2, int a3) {
        Assertions.assertEquals(a1, obj.getInt("a1"));
        Assertions.assertEquals(a2, obj.getInt("a2"));
        Assertions.assertEquals(a3, obj.getInt("a3"));
    }
    ...
    private void assertRecord(HollowObject obj, String fnPrefix, int... vals) {
        for (int i = 0; i < vals.length; i++) {
            ...
            Assertions.assertEquals(vals[i], obj.getInt(fn));
        }
    }
