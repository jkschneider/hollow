...
public class HollowFieldMatchQueryTest {
    ...
    public void matchesRecordsOfAnyType() {
        ...
        Assertions.assertEquals(1, matches.get("TypeA").cardinality());
        Assertions.assertTrue(matches.get("TypeA").get(1));

        Assertions.assertEquals(1, matches.get("TypeB").cardinality());
        Assertions.assertTrue(matches.get("TypeB").get(1));
    }
    ...
    public void matchesOnlyRecordsWithSpecifiedField() {
        ...
        Assertions.assertEquals(1, matches.size());
        Assertions.assertEquals(1, matches.get("TypeB").cardinality());
        Assertions.assertTrue(matches.get("TypeB").get(3));
    }
